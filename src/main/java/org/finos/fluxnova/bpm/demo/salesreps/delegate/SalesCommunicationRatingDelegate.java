...
@Component("salesCommunicationRatingDelegate")
public class SalesCommunicationRatingDelegate implements JavaDelegate {

    private final ChatModel chatModel;

    public SalesCommunicationRatingDelegate(ChatModel chatModel) {
    ...
    public void execute(DelegateExecution execution) {
        ...
        System.out.println("Sales communication rating JSON: " + cleanedResponse);
